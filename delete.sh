...
echo "→ Aktualisiere uebersicht-alt.html..."

python3 - <<PYEOF
import re, json

with open("$REPO_DIR/uebersicht-alt.html", "r", encoding="utf-8") as fh:
    content = fh.read()
...
with open("$REPO_DIR/uebersicht-alt.html", "w", encoding="utf-8") as fh:
    fh.write(new_content)

print("  uebersicht-alt.html aktualisiert.")
PYEOF
